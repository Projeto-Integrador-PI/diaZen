...
@section('style')
    <style>
        ...
        .btn-primary:hover {
            ...
            /* Nova cor para o hover do botão "Cancelar" */
            color: #FFFFFF;
            /* Nova cor para o texto do hover */
        }
...
@endsection
@section('content')
    <form class="content" method="POST" action="{{ route('daily.store') }}">
        @csrf
        <div class="container">
            ...
            <form action="" class="fields">
                ...
                <input type="text" id="sbom" placeholder="Digite aqui..." name="good">
                <label for="sruim">O que houve de ruim?</label>
                <input type="text" id="sruim" placeholder="Digite aqui..." name="bad">
                <label for="sobs">Alguma observação?</label>
                <input type="text" id="sobs" placeholder="Digite aqui..." class="resized-text" name="description">
            </form>
            <div class="small-button">
                <div>
                    <a href="{{ route('home.dashboard') }}" class="btn btn-primary" type="button">Cancelar</a>
                </div>
                <div>
